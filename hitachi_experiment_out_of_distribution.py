    ...
    for learning_rate in learning_rate_values:
            for batch_size in batch_size_values:
                ...
                for i, (train_index, val_index) in dataset_splits:
                    ...
                    # Instancia o modelo Hitachi com os parâmetros atuais
                    ...
                    model_Hitachi.fit(X_train_KFold, y_train_fold)
...
if __name__ == "__main__":
    ...
    info("main line")
    p = Process(target=run_hitachi_experiment)
    p.start()
    p.join()