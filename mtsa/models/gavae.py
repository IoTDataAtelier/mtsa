...
from mtsa.utils import Wav2Array
from mtsa.models.GANF_components.gavaeBaseModel import GAVAEBaseModel

class GAVAE(nn.Module, BaseEstimator, OutlierMixin):
    ...
    def __init__(self, 
        ...
        self.mono = mono
        self.final_model = GAVAEBaseModel(index_CUDA_device=index_CUDA_device)
