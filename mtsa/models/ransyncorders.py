...
class RANSynCodersBase():
    ...
    def __train_model_with_default_data(self, X, timestamps_matrix, learning_rate, epochs, freq_warmup, sin_warmup, pos_amp, shuffle):
    ...
    def __train_anomaly_detector(self, learning_rate, epochs, dataset):
        with tf.device('/gpu:1'):
            for epoch in range(epochs):
                ...
                self.experiment_dataframe.loc[len(self.experiment_dataframe)] = {"total_epochs": epochs,
