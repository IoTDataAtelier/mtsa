        ...
        for learning_rate in learning_rate_values:
            for epochs in epochs_size_values:
                for batch_size in batch_size_values:
                    ...
                    experiment_dataframe.to_csv(f'EXP_MFCC_VALVE-{machine_id}_MTSA_CV_'+'fold_'+str(fold)+'.csv', sep=',', encoding='utf-8')
                    
        experiment_dataframe.to_csv(f'EXP_MFCC_VALVE-{machine_id}_MTSA_CV.csv', sep=',', encoding='utf-8')
