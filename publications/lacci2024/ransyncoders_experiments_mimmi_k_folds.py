        ...
        for learning_rate in learning_rate_values:
            for batch_size in batch_size_values:
                ...
                for fold, (train_index, test_index) in dataset_splits:
                    ...
                    model_RANSynCoders = RANSynCoders(sampling_rate=sampling_rate_sound, data_type=DataType.AUDIO)
                    
                    model_RANSynCoders.fit(x_train_fold, y_train_fold, batch_size=batch_size, learning_rate=learning_rate, epochs=epochs)
                ...
                experiment_dataframe.loc[len(experiment_dataframe)] = {'batch_size': batch_size, 'epoch_size': epochs, 'learning_rate': learning_rate, 'sampling_rate': sampling_rate_sound,'AUC_ROCs': str(scores), 'Confidence_interval_AUC_ROC': str(ci)}
                experiment_dataframe.to_csv('EXP_MIMMI_RANSynCoders_MTSA_CV_'+'fold_'+str(fold)+'.csv', sep=',', encoding='utf-8')
                
    experiment_dataframe.to_csv('EXP_MIMMI_RANSynCoders_MTSA_CV.csv', sep=',', encoding='utf-8')
